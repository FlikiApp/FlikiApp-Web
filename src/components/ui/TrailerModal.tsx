      ...
      {movie && (
        ...
        >
          ...
          <motion.button
            ...
            className="absolute top-4 right-4 sm:top-6 sm:right-6 w-10 h-10 rounded-full flex items-center justify-center text-text-primary transition-transform duration-200 hover:scale-110"
            style={{
              backgroundImage:
