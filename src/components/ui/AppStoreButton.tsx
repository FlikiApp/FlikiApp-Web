...
export default function AppStoreButton({ className = '' }: AppStoreButtonProps) {
  return (
    <a
      ...
      className={`inline-flex items-center gap-3 bg-text-primary text-white px-6 py-3.5 rounded-xl font-medium text-base hover:opacity-80 transition-opacity duration-200 ${className}`}
    >
